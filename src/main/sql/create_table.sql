...
CREATE TABLE `report` (
  ...
  `new_vc_sec1` int(11) NOT NULL DEFAULT '0' COMMENT '対処すべき課題初出語彙数',
  `past_rd_new_vc_sec1` int(11) NOT NULL DEFAULT '0' COMMENT '初出語彙数中、過去の研究開発活動あり語彙数',
  `vc_sec2` int(11) NOT NULL DEFAULT '0' COMMENT '研究開発活動語彙数',
  `new_vc_sec2` int(11) NOT NULL DEFAULT '0' COMMENT '研究開発活動初出語彙数',
...
CREATE TABLE `report_word` (
  ...
  `first_app` bit(1) NOT NULL DEFAULT b'0' COMMENT '初出単語',
  `past_rd` bit(1) NOT NULL DEFAULT b'0' COMMENT '過去の研究開発活動あり',
